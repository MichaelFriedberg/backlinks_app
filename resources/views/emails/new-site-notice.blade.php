								...
								<td width="200" valign="top" align="center">
									<div class="contentEditableContainer contentImageEditable">
					                	<div class="contentEditable" align='center' >
					                  		<img src="https://ci3.googleusercontent.com/proxy/ifpOPQpQjCROB2mvIHqsIA0P6Yl7K9YKeynxRyEWP1MVhZ3FIp1WN0SDRhwO6nH2T_wNBGwIw7Ex3uDqBcm1BTT8I5r2pWnjLChsXEbqAuU=s0-d-e1-ft#https://avatars1.githubusercontent.com/u/6422482?v=3&s=400" width="155" height="155"  alt='Logo'  data-default="placeholder" /><h1>BloggerBot</h1>
					                	</div>
					              	</div>
								</td>
								<td width="200" valign="top">&nbsp;</td>
									...
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='left' >
					                  		<p >Disla,
					                  			<br/>
					                  			<br/>
												{{ $website }} has been added to our repository by {{ $name }} : {{ $email }}!</p>
					                	</div>
					              	</div>
								</td>
								<td width="100">&nbsp;</td>
