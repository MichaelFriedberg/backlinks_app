								...
								<td width="200" valign="top" align="center">
									<div class="contentEditableContainer contentImageEditable">
					                	<div class="contentEditable" align='center' >
					                  		<img src="https://ci3.googleusercontent.com/proxy/ifpOPQpQjCROB2mvIHqsIA0P6Yl7K9YKeynxRyEWP1MVhZ3FIp1WN0SDRhwO6nH2T_wNBGwIw7Ex3uDqBcm1BTT8I5r2pWnjLChsXEbqAuU=s0-d-e1-ft#https://avatars1.githubusercontent.com/u/6422482?v=3&s=400" width="155" height="155"  alt='Logo'  data-default="placeholder" /><h1>BloggerBucks.org
											</h1>
					                	</div>
					              	</div>
								</td>
							...
							<tr>
								<td width="100%" colspan="3" align="center" style="padding-bottom:10px;padding-top:25px;">
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='center' >
					                  		<h2 >New User Registration Completed</h2>
					                	</div>
					              	</div>
								</td>
							</tr>
									...
									<div class="contentEditableContainer contentTextEditable">
					                	<div class="contentEditable" align='left' >
					                  		<p >Disla,
					                  			<br/>
					                  			<br/>
												{{ $name }} has signed up to bloggergucks.org<br/>The BloggerBot will alert you when he/she adds a website to the App!<br/><br/>User Email: {{ $email }}</p>
					                	</div>
					              	</div>
								</td>
								<td width="100">&nbsp;</td>
									...
									<table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
										<tr>
											<td bgcolor="#ED006F" align="center" style="border-radius:4px;" width="200" height="50">
												<div class="contentEditableContainer contentTextEditable">
								                	<div class="contentEditable" align='center' >
								                  		<a target='_blank' href="http://bloggerbucks.org/admin/login" class='link2'>BloggerBucks Admin Pannel</a>
								                	</div>
								              	</div>
											</td>
										</tr>
